...
export const baseTheme = EditorView.baseTheme({
  ...
  // Collapse toggle button (hidden by default, shown on line hover)
  '.cm-collapse-toggle': {
    display: 'inline-flex',
    alignItems: 'center',
  ...
  '.cm-line:hover .cm-collapse-toggle': {
    opacity: '0.4',
  },
  '.cm-line:hover .cm-collapse-toggle:hover': {
    opacity: '1',
  },
  // Always show chevrons on touch devices (no hover support)
  '@media (hover: none)': {
    '.cm-collapse-toggle': {
      opacity: '0.4',
    },
