...
export const lightTheme = EditorView.theme({
  ...
  // Header colors
  '.cm-markdown-preview .md-h1': { color: '#1a1a1a' },
  '.cm-markdown-preview .md-h2': { color: '#2a2a2a' },
  '.cm-markdown-preview .md-h3': { color: '#3a3a3a' },
  '.cm-markdown-preview .md-h4': { color: '#4a4a4a' },
  '.cm-markdown-preview .md-h5': { color: '#5a5a5a' },
  '.cm-markdown-preview .md-h6': { color: '#6a6a6a' },
